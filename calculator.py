...
class Calc(object):
    def __init__(self,parent=tk.Tk()):
        ...
        self.display=tk.Entry(self.parent,font=('verdana',20,"normal"),validate="key",validatecommand=display_entry_validate,
                                textvariable=self.display_stringvar)
        self.display.bind('<Return>',self.calc_expression)


#-----------------------number keypad creion--------------
        ...
        self.bt_devide=tk.Button(self.parent,text="/",command=lambda:self.button_press('/'))
...
#------------------------------graphics component------------------------
    ...
    def mount_gui(self):
        ...
        self.bt_devide.grid(row=4,column=3,sticky="ewns",padx=2,pady=2)
        self.bt_point.grid(row=4,column=1,sticky="ewns",padx=2,pady=2)
        self.bt_equal.grid(row=4,column=2,sticky="ewns",padx=2,pady=2)
        self.bt_clear.grid(row=5,column=0,columnspan=3,sticky="ewns",padx=2,pady=2)
...
#---------------------------------About----------------------------
    ...
    def about(self):
        ...
        tk.Label(about_window,text="calculator",font=("verdana",15,"bold")).grid(row=0,column=0,padx=5,pady=5,sticky="s")
        tk.Label(about_window,text="Python Calculator").grid(row=1,column=0,padx=5,pady=5,sticky="s")
        tk.Label(about_window,text="This calculator is Developed in Python 3").grid(row=3,column=0,padx=5,pady=5,sticky="s")
        tk.Label(about_window,text="armankhaaa@gmail.com").grid(row=4,column=0,padx=5,pady=5,sticky="s")
    ...
    def only_number_entry(self,key_press,cod):
        ...
        if (num_chars_now==0):
            ...
            if(last_char in "+-*/" and key_press in "+-*/." and cod == '1'):
                ...
                return True
            elif(last_char in "." and key_press in "+-*/." and cod == '1'):
                return False
            elif(last_char in "." and key_press in "+-*/." and cod == '0'):
                return True
    ...
    def button_press(self,bt):
        ...
        if(char_num==0):
            ...
            if(bt=='.' and not last_char in "+-*/"):
                print("decimal point unavaiable")
            else:
